...
export const SETTING_KEYS = {
  ...
  WORKSPACE_CURRENCY_CODE: "currency.code",
  WORKSPACE_CURRENCY_SYMBOL: "currency.symbol",
...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  [SETTING_KEYS.WORKSPACE_CURRENCY_CODE]: "EGP",
  [SETTING_KEYS.WORKSPACE_CURRENCY_SYMBOL]: "EGP",
